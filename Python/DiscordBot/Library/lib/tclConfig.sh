...
# installed.
TCL_PREFIX='F:/Coding stuff/personal-stuff/Python/DiscordBot\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/Coding stuff/personal-stuff/Python/DiscordBot\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/Coding stuff/personal-stuff/Python/DiscordBot\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/Coding stuff/personal-stuff/Python/DiscordBot\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/Coding stuff/personal-stuff/Python/DiscordBot\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/Coding stuff/personal-stuff/Python/DiscordBot\Library\lib\tclstub86.lib'
